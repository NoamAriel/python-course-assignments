...
tree_path= Path(r"D:\python\Lab\caddisfly\ncbi_fibroin_sequences\phylo_tree.json")
index_path= Path(r"D:\python\Lab\caddisfly\Species_Index.md")
out_path= Path(r"D:\python\Lab\caddisfly\taxonomy_tree")
data_root= Path(r"D:\python\Lab\caddisfly\ncbi_fibroin_sequences")
